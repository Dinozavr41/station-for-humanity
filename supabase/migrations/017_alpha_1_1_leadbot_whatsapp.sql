-- Alpha 1.1: WhatsApp Cloud API channel for multichannel LeadBot.
...
declare
  allowed text[] := array[
    ...
    'whatsapp_access_token','whatsapp_app_secret','whatsapp_verify_token','whatsapp_phone_number_id','whatsapp_waba_id','whatsapp_graph_version','whatsapp_manager_phone',
